...
<div id="chatter" class="discussion">
	...
	<div id="chatter_header" style="background-color:{{ $discussion->color }}">
		...
		<span class="chatter_head_details">
			...
			<a class="chatter_cat" href="/{{ Config::get('chatter.routes.home') }}/{{ Config::get('chatter.routes.category') }}/{{ $discussion->category->slug }}" style="background-color:{{ $discussion->category->color }}">{{ $discussion->category->name }}
			</a>
		</span>
	</div>
		                		...
		                		<span class="chatter_posts">
					        		...
					        		<div class="chatter_middle">
					        			<span class="chatter_middle_details">
											<a href="/profile/{{$post->user->id}}">{{$post->user->nick_name}}</a>
											<span class="ago chatter_middle_details">{{ \Carbon\Carbon::createFromTimeStamp(strtotime($post->created_at))->diffForHumans() }}</span></span>

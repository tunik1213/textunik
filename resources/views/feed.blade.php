    ...
    <div class="container col-md-9">
        ...
        <div class="container col-xl-4 hidden-lg right-banner">
            ...
            <div class="right-banner-content">
                ...
                <p><strong>Рерайтинг</strong> (<em>rewriting</em><em>)</em> – перефразирование без потери смысла исходного текста в новый, который будет уникальным для поисковых систем. Процесс изменения текста напоминает написание школьного изложения.</p>
                <p><strong>Рерайт&nbsp;</strong>(<em>rewrite)</em><em>&nbsp;</em>– это результат рерайтинга. То есть, новый текст, который получился на выходе</p>
            </div>

...
return [
    ...
    'discussion' => [
        'new'          => '����� '.trans('chatter::intro.titles.discussion'),
        'all'          => '��� '.trans('chatter::intro.titles.discussion'),
    ...
    'editor' => [
        ...
        'select_color_text'   => 'Select a Color for this 1 '.trans('chatter::intro.titles.discussion').' (optional)',
    ],

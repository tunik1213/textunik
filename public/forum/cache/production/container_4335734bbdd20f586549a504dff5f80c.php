...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000002c1b01af000000001c364877(
...
class phpbbtemplatetwiglexer_000000002c1b01af000000001c364877 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5d8cc5d01ad38338093699 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5d8cc5d01ad4c002476032 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5d8cc5d01ace7498260299 = array(
    ...
    {
        $this->initializer5d8cc5d01ad4c002476032 && ($this->initializer5d8cc5d01ad4c002476032->__invoke($valueHolder5d8cc5d01ad38338093699, $this, 'set_environment', array('env' => $env), $this->initializer5d8cc5d01ad4c002476032) || 1) && $this->valueHolder5d8cc5d01ad38338093699 = $valueHolder5d8cc5d01ad38338093699;

        return $this->valueHolder5d8cc5d01ad38338093699->set_environment($env);
    }
    ...
    {
        $this->initializer5d8cc5d01ad4c002476032 && ($this->initializer5d8cc5d01ad4c002476032->__invoke($valueHolder5d8cc5d01ad38338093699, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5d8cc5d01ad4c002476032) || 1) && $this->valueHolder5d8cc5d01ad38338093699 = $valueHolder5d8cc5d01ad38338093699;

        return $this->valueHolder5d8cc5d01ad38338093699->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5d8cc5d01ad4c002476032 && ($this->initializer5d8cc5d01ad4c002476032->__invoke($valueHolder5d8cc5d01ad38338093699, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5d8cc5d01ad4c002476032) || 1) && $this->valueHolder5d8cc5d01ad38338093699 = $valueHolder5d8cc5d01ad38338093699;

        return $this->valueHolder5d8cc5d01ad38338093699->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5d8cc5d01ad4c002476032 = $initializer;
    }
    ...
    {
        $this->initializer5d8cc5d01ad4c002476032 && ($this->initializer5d8cc5d01ad4c002476032->__invoke($valueHolder5d8cc5d01ad38338093699, $this, '__get', array('name' => $name), $this->initializer5d8cc5d01ad4c002476032) || 1) && $this->valueHolder5d8cc5d01ad38338093699 = $valueHolder5d8cc5d01ad38338093699;

        if (isset(self::$publicProperties5d8cc5d01ace7498260299[$name])) {
            return $this->valueHolder5d8cc5d01ad38338093699->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5d8cc5d01ad38338093699;
    ...
    {
        $this->initializer5d8cc5d01ad4c002476032 && ($this->initializer5d8cc5d01ad4c002476032->__invoke($valueHolder5d8cc5d01ad38338093699, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5d8cc5d01ad4c002476032) || 1) && $this->valueHolder5d8cc5d01ad38338093699 = $valueHolder5d8cc5d01ad38338093699;
    ...
    {
        $this->initializer5d8cc5d01ad4c002476032 && ($this->initializer5d8cc5d01ad4c002476032->__invoke($valueHolder5d8cc5d01ad38338093699, $this, '__isset', array('name' => $name), $this->initializer5d8cc5d01ad4c002476032) || 1) && $this->valueHolder5d8cc5d01ad38338093699 = $valueHolder5d8cc5d01ad38338093699;
    ...
    {
        $this->initializer5d8cc5d01ad4c002476032 && ($this->initializer5d8cc5d01ad4c002476032->__invoke($valueHolder5d8cc5d01ad38338093699, $this, '__unset', array('name' => $name), $this->initializer5d8cc5d01ad4c002476032) || 1) && $this->valueHolder5d8cc5d01ad38338093699 = $valueHolder5d8cc5d01ad38338093699;
    ...
    {
        $this->initializer5d8cc5d01ad4c002476032 && ($this->initializer5d8cc5d01ad4c002476032->__invoke($valueHolder5d8cc5d01ad38338093699, $this, '__clone', array(), $this->initializer5d8cc5d01ad4c002476032) || 1) && $this->valueHolder5d8cc5d01ad38338093699 = $valueHolder5d8cc5d01ad38338093699;

        $this->valueHolder5d8cc5d01ad38338093699 = clone $this->valueHolder5d8cc5d01ad38338093699;
    }

    public function __sleep()
    {
        $this->initializer5d8cc5d01ad4c002476032 && ($this->initializer5d8cc5d01ad4c002476032->__invoke($valueHolder5d8cc5d01ad38338093699, $this, '__sleep', array(), $this->initializer5d8cc5d01ad4c002476032) || 1) && $this->valueHolder5d8cc5d01ad38338093699 = $valueHolder5d8cc5d01ad38338093699;

        return array('valueHolder5d8cc5d01ad38338093699');
    }
    ...
    {
        return $this->initializer5d8cc5d01ad4c002476032;
    }
    ...
    {
        return $this->initializer5d8cc5d01ad4c002476032 && ($this->initializer5d8cc5d01ad4c002476032->__invoke($valueHolder5d8cc5d01ad38338093699, $this, 'initializeProxy', array(), $this->initializer5d8cc5d01ad4c002476032) || 1) && $this->valueHolder5d8cc5d01ad38338093699 = $valueHolder5d8cc5d01ad38338093699;
    }
    ...
    {
        return null !== $this->valueHolder5d8cc5d01ad38338093699;
    }
    ...
    {
        return $this->valueHolder5d8cc5d01ad38338093699;
    }
